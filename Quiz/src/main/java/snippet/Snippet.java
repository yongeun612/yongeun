...
public class Snippet {
	...
	<head>
	  <script>
	  	...
	  	function list(page){
	  		location.href="${path}/app/boardPage.do?curPage="+page+"&searchOption=${map.searchOption}"+"&keyword=${map.keyword}";
	  	}
	  </script>
	...
	<body>
	  ...
	  <form name="searchForm" method="post" action="${path}/app/boardPage.do">
